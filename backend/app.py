...
def load_env_variables():
    global FLASK_SECRET_KEY, SESSION_TYPE, CLIENT_ID, CLIENT_SECRET, PROJECT_ID, REDIRECT_URI_BACKEND_CALLBACK, REDIRECT_FRONTEND_URI, JAVASCRIPT_ORIGINS
    FLASK_SECRET_KEY = os.environ.get('FLASK_SECRET_KEY')
    SESSION_TYPE = os.environ.get('SESSION_TYPE')
    CLIENT_ID = os.environ.get('CLIENT_ID')
    CLIENT_SECRET = os.environ.get('CLIENT_SECRET')
    PROJECT_ID = os.environ.get('PROJECT_ID')
    REDIRECT_URI_BACKEND_CALLBACK = os.environ.get('REDIRECT_URI_BACKEND_CALLBACK')
...
client_secretos = {
    "web": {
        ...
        "redirect_uris": [ REDIRECT_URI_BACKEND_CALLBACK ],
...
flow = Flow.from_client_config(
    ...
    redirect_uri= REDIRECT_URI_BACKEND_CALLBACK
)
...
def callback():
    ...
    return redirect(f"{REDIRECT_FRONTEND_URI}{token}")
